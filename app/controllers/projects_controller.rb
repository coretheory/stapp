class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:title, :subtitle, :year, :project_type, :intro, :body, :outro, :project_team, :header_image, :footer_image, :architectural_design, :graphic_design, :illustration, :product_design, :user_id, :alt_grid_layout, :thesis_grid_layout, :one_grid_layout, :two_grid_layout, :three_grid_layout, body_images: [])
    end
end
